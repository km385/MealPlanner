<template>
    ...
    <div v-if="isEditing" class="p-6">
        <div class="mb-8">
            ...
            <ul class="space-y-3 mb-6">
                <li v-for="(item, index) in editedRecipe.ingredients" :key="item.ingredient.id"
                    class="flex justify-between items-center bg-gray-50 p-3 rounded">
                    <span class="font-medium">{{ item.ingredient.name }}</span>
                    <div class="flex items-center gap-4">
                        <input type="number" v-model.number="item.quantity" class="w-24 px-2 py-1 border rounded"
                            min="0">
            ...
            <div class="flex items-end gap-4 bg-gray-50 p-4 rounded">
                <div class="flex-1">
                    ...
                    <input type="text" v-model="newIngredientForm.name" class="w-full p-2 border rounded"
                ...
                <div class="w-32">
                    ...
                    <input type="number" v-model.number="newIngredientForm.quantity" class="w-full p-2 border rounded"
                        min="0">
                </div>
                <div class="w-40">
                    <label class="block text-sm font-medium text-gray-700 mb-1">
                ...
                <button @click="addIngredient" :disabled="!newIngredientForm.name || !newIngredientForm.quantity"
    ...
    <div class="mb-8">
        ...
        <textarea v-model="editedRecipe.instructions" class="w-full p-3 border rounded" rows="4"></textarea>
    </div>
</template>
